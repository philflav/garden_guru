...
export const LeafIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M4 10a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2H4Z" />
    <path d="M11 4a2 2 0 0 0 2-2h4a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-2" />
  </svg>
);
...
export const SproutIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M12 14c1.2 0 2.3-1.3 3-3-1-2-2.5-3-4-3-1.5 0-3 1-4 3 .7 1.7 1.8 3 3 3z" />
        <path d="M12 8c0-2.5-1.5-5-4-5" />
        <path d="M12 8c0-2.5 1.5-5 4-5" />
    </svg>
);
...
export const BugIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 20a8 8 0 0 1-8-8V7a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v5a8 8 0 0 1-8 8z"/>
        <path d="M12 20v-4"/><path d="M4 12H2"/><path d="M20 12h2"/>
        <path d="m15 7-3 5-3-5"/>
        <path d="M4 7h2"/><path d="M18 7h2"/>
    </svg>
);

export const RulerIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M21.3 15.3a2.4 2.4 0 0 1 0 3.4l-2.6 2.6a2.4 2.4 0 0 1-3.4 0L3 8.7a2.4 2.4 0 0 1 0-3.4l2.6-2.6a2.4 2.4 0 0 1 3.4 0l12.3 12.3z"/>
        <path d="m18 6 2-2"/>
        <path d="m15 9-6 6"/>
        <path d="m12 12-2 2"/>
        <path d="m9 15-2 2"/>
